...
export interface CodepipelineBuildDeployStackProps extends cdk.StackProps {
...
export class CodepipelineBuildDeployStack extends cdk.Stack {
  constructor(
    scope: Construct,
    id: string,
    props: CodepipelineBuildDeployStackProps
  ) {
    ...
    new codebuild.GitHubSourceCredentials(this, 'GithubCredentials', {
      accessToken: cdk.SecretValue.unsafePlainText(props.oauthToken),
    });
